    ...
    <div class="justify-content-center">
        ...
        <div class="row">
            ...
            <div class="col-12 mb-3">
                <a href="{{route('brands.create')}}" class="btn btn-danger float-right mr-2">Crear Marca</a>
            </div>

            @if ($brands->total() == 0)
                <h3 class="text-center col-12 mt-5 text-danger">No hay marcas registradas</h3>
            @endif
