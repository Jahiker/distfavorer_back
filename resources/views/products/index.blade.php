        ...
        <div class="justify-content-center">
            ...
            <div class="row">
                ...
                <div class="col-12 mb-3">
                    <a href="{{route('products.create')}}" class="btn btn-info float-right mr-2">Crear Producto</a>
                </div>

                @if ($products->total() == 0)
                    <h3 class="text-center col-12 mt-5 text-danger">No hay productos registrados</h3>
                @endif
                ...
                @foreach ($products as $product)
                    ...
                    <div class="p-2 col-12">
                        ...
                        <div class="card-body row">
                            <div class="col-2">
                                <img class="bg-dark" src="{{$product->image}}" height="100px" class="img-thumbnail"  alt="">
                            </div>
