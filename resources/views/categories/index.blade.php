        ...
        <div class="justify-content-center">
            ...
            <div class="row">
                ...
                <div class="col-12 mb-3">
                    <a href="{{route('categories.create')}}" class="btn btn-success float-right mr-2">Crear Categoria</a>
                </div>

                @if ($categories->total() == 0)
                    <h3 class="text-center col-12 mt-5 text-danger">No hay categorias registradas</h3>
                @endif
